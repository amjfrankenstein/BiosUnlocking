#!/bin/bash
rm -r fu/unl/* >/dev/dev/null
fu/spifullread.sh
echo :::::::::::::::::::::::::PATCHING::BIN:::::::::::::::::::::::::::::

cd fu/unl 2>/dev/null
BOX86_NOBANNER=1 wine '../../autopatcher/RCUnlocker.exe' fullread1.bin | zenity --progress --title="Unlocking Chip..." --text="Patching Chip..." --width=350 --auto-close --auto-kill --pulsate --time-remaining --percentage=100

if [ -f "fullunlock1_unlocked.bin" ]; then
