...
yad --height=250 --width=450 --form --title="Choose File" --field=File:FL --center > ls/unl/write.out
...
if grep -q Error  test.out; then
     zenity --height=100 --width=300 --timeout=3 --error --text="Failed writing."
else
     zenity --height=100 --width=300 --timeout=3 --info --text="Sucess!"     
fi
